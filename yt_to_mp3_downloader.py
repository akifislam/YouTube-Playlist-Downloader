...
#Playlist URL
YOUTUBE_PLAYLIST_URL = input("Enter the URL of your playlist") or 'https://www.youtube.com/playlist?list=PLB-0AGqg4hO99EoYUGyaR4H-1zBqN5wvi'

#Enter the directory address where you want to save songs
download_directory = "/Users/akifislam/Desktop/YouTubePlaylistDownloader" or '.'
