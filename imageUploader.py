...
path = input("Enter a directory path to batch upload photos to [http://moodle.mpower-social.com/converter/pix/upload.php]\n(Example:/Users/akifislam/Downloads/auto images)\n\n")
